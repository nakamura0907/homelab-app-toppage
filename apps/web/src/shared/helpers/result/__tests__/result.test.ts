...
describe("Result", () => {
    ...
    describe('成功したResult', () => {
        it('Resultクラスをインスタンス化する', () => {
            expect(() => { Result.ok(value) }).not.toThrow();
            expect(() => { new Result(value, null) }).not.toThrow();
        })
        it('成功と失敗を判定する', () => {
    ...
    describe('失敗したResult', () => {
        it('Resultクラスをインスタンス化する', () => {
            expect(() => { Result.err(err) }).not.toThrow();
            expect(() => { new Result(null, err) }).not.toThrow();
        })
        it('成功と失敗を判定する', () => {
    ...
    describe('成功と失敗の値が渡されたResult', () => {
        it('Resultクラスをインスタンス化する', () => {
            expect(() => { new Result(value, err) }).toThrow();
        })
    })
